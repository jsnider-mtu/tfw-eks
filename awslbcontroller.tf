...
resource "aws_iam_role_policy" "lb-controller" {
  ...
  role = aws_iam_role.lb-controller.id
    ...
    "Statement": [
        {
            ...
            "Condition": {
                "StringEquals": {
                    "oidc.eks.us-east-1.amazonaws.com/id/188020E1CD2C0191ECE6A6C32DC95755:sub": "system:serviceaccount:kube-system:aws-load-balancer-controller"
                }
            }
        }
    ]
...
POLICY
  ...
  tags = module.lb_controller_label.tags
}
